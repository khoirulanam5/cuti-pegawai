...
<body>
    ...
    $insert = mysqli_query($con, "UPDATE `tb_pengajuan_cuti` SET `validasi_pemimpin`='$validasi_cuti',tgl_validasi='$tgl_validasi',`status_pengajuan`='$status_pengajuan' WHERE `id_pengajuan_cuti`='$id_pengajuan_cuti'");
