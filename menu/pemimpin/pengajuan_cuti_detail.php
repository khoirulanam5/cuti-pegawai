...
<div class="modal-body">
    <form action="proses/pemimpin/pengajuan_cuti_validasi.php" method="POST" enctype="multipart/form-data">
        <div class="row mb-3">
            <label for="inputEmail" class="col-sm-4 col-form-label">Validasi Pimpinan</label>
            <div class="col-sm-8">
