...
<table id="example" class="table table-striped" style="width:100%">
    ...
    <?php
    $no = 1;
    $view = list_pengaujuan_cuti_by_karyawan($id_user);
    ...
    ?>
        <tr style="text-align: center;">
            ...
            <td>
                ...
                ?>
                    <div style="color: red;"><b><?= $row['status_pengajuan'] ?></b></div>
                <?php
                } else {
                ?>
                    <div style="color: blue;"><b><?= $row['status_pengajuan'] ?></b></div>
                <?php
                }
                ?>
            </td>
            ...
            <div class="modal-body">
                <form action="proses/karyawan/pengajuan_tambah.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-8">
                            <input type="date" name="tgl_pengajuan" class="form-control" autocomplete="off" value="<?= date("Y-m-d") ?>" readonly>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-8">
                            <input type="date" name="tgl_awal" class="form-control" autocomplete="off" value="<?= date("Y-m-d") ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-8">
                            <input type="date" name="tgl_akhir" class="form-control" autocomplete="off" value="<?= date("Y-m-d") ?>" required>
                        </div>
                    </div>
                    ...
                    <!-- <div class="row mb-3">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="keperluan" class="form-control" autocomplete="off" required>
                        </div>
                    </div> -->
