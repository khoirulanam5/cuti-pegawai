                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <button class="dropdown-item" id="edit" value="<?= $row['id_devisi'] ?>">
                                                    <i class="bi bi-pencil-square"></i> Edit
                                                </button>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="proses/admin/devisi_hapus.php?id=<?= $row['id_devisi'] ?>" onclick="return confirm('Apakah anda yakin ingin menghapus devisi <?= $row['nm_devisi'];?>?');">
            ...
            <div class="modal-body">
                <form action="proses/admin/devisi_tambah.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="nm_devisi" class="form-control" autocomplete="off" required>
                        </div>
                    </div>
...
<script>
    $(document).on('click', '#edit', function(e) {
        ...
        var fileedit = 'menu/admin/devisi_detail.php';
        $.ajax({
            type: 'POST',
            url: fileedit,
