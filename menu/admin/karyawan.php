                    ...
                    <table id="example" class="table table-striped" style="width:100%">
                        ...
                        ?>
                            <tr style="text-align: center;">
                                ...
                                <td>
                                    <img src="assets/foto_karyawan/<?= $row['foto_karyawan'] ?>" style="width:50%">
                                </td>
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <button class="dropdown-item" id="edit" value="<?= $row['id_karyawan'] ?>">
                                                    <i class="bi bi-pencil-square"></i> Edit
                                                </button>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="proses/admin/karyawan_hapus.php?id=<?= $row['id_karyawan'] ?>" onclick="return confirm('Apakah anda yakin ingin menghapus data <?= $row['nm_karyawan'];?>?');">
            ...
            <div class="modal-body">
                <form action="proses/admin/karyawan_tambah.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="nm_karyawan" class="form-control" autocomplete="off" required>
                        </div>
                    </div>
                    ...
                    <fieldset class="row mb-3">
                        ...
                        <div class="col-sm-8">
                            <select name="id_devisi" class="form-select" required>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="no_karyawan" class="form-control" autocomplete="off" required>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-8">
                            <input type="file" name="foto_karyawan" class="form-control" autocomplete="off" required>
                        </div>
                    </div>
...
<script>
    $(document).on('click', '#edit', function(e) {
        ...
        var fileedit = 'menu/admin/karyawan_detail.php';
        $.ajax({
            type: 'POST',
            url: fileedit,
