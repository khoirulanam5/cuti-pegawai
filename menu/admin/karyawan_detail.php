...
<div class="modal-body">
    <form action="proses/admin/karyawan_edit.php" method="POST" enctype="multipart/form-data">
        <div class="row mb-3">
            ...
            <div class="col-sm-8">
                <input type="text" name="nm_karyawan" class="form-control" autocomplete="off" value="<?= $data['nm_karyawan'] ?>" required>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-8">
                <input type="text" name="NIS" class="form-control" autocomplete="off" value="<?= $data['NIS'] ?>" required>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-8">
                <input type="text" name="jabatan" class="form-control" autocomplete="off" value="<?= $data['jabatan'] ?>" required>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-8">
                <input type="text" name="alamat" class="form-control" autocomplete="off" value="<?= $data['alamat'] ?>" required>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-8">
                <input type="text" name="no_karyawan" class="form-control" autocomplete="off" value="<?= $data['no_karyawan'] ?>" required>
            </div>
        </div>
