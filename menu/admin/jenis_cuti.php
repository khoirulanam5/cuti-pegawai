                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <button class="dropdown-item" id="edit" value="<?= $row['id_jenis_cuti'] ?>">
                                                    <i class="bi bi-pencil-square"></i> Edit
                                                </button>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="proses/admin/jenis_cuti_hapus.php?id=<?= $row['id_jenis_cuti'] ?>" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')">
            ...
            <div class="modal-body">
                <form action="proses/admin/jenis_cuti_tambah.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="nm_jenis_cuti" class="form-control" autocomplete="off" required>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="durasi_cuti_max" class="form-control" autocomplete="off" required>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="ket_jenis_cuti" class="form-control" autocomplete="off" required>
                        </div>
                    </div>
