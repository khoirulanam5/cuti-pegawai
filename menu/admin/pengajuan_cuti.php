                        ...
                        ?>
                            <tr style="text-align: center;">
                                ...
                                <td>
                                    ...
                                    ?>
                                        <div style="color: blue;"><b><?= $row['tgl_pengajuan'] ?></b></d>
                                    <?php
                                    }
                                    ?>
                                ...
                                <td>
                                 ...
                                 <?php
                                    if ($row['status_pengajuan'] == "Pengajuan") {
                                    ?>
                                    ...
                                    ?>
                                    <p>Telah Divalidasi Admin</p>
                                    <?php
                                    }else {
                                        ?>
                                        <p>Telah Divalidasi Pemimpin</p>
                                    <?php
                                    } 
                                     ?>
            ...
            <div class="modal-body">
                <form action="proses/karyawan/pengajuan_tambah.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-8">
                            <input type="date" name="tgl_pengajuan" class="form-control" autocomplete="off" value="<?= date("Y-m-d") ?>">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-8">
                            <select name="id_jenis_cuti" id="id_jenis_cuti" class="form-select">
...
<script>
    $(document).on('click', '#edit', function(e) {
        ...
        var fileedit = 'menu/admin/pengajuan_cuti_detail.php';
        $.ajax({
            type: 'POST',
            url: fileedit,
